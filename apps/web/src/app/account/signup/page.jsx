    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-50 p-4">
      ...
      >
        ...
        <p className="mb-8 text-center text-gray-600">
          Create an account to manage videos
        </p>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-3 focus-within:border-[#725BFF] focus-within:ring-1 focus-within:ring-[#725BFF]">
              <input
                required
                name="email"
                type="email"
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <a
              ...
              className="text-[#725BFF] hover:text-[#6A57FF]"
            >
              Sign in
            </a>
          </p>
